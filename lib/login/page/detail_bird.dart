...
class Detailsbird extends StatelessWidget {
  final InfoRabbit infob;
  Detailsbird({required this.infob});
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Hero(
                  tag: infob.id_Rabbit,
                  child: FadeInImage(
                    image: AssetImage(infob.image_Bird),
                    fit: BoxFit.cover,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                ...
                componentInfo(
                  component: infob.component_Bird,
                ),
                ...
                knowpet(
                  needknowpet: infob.needknowPet_Bird,
                ),
